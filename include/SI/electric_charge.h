...
struct electric_charge_t : public unit_t<'Q', _Exponent, _Ratio, _Type>
{
  using unit_t<'Q', _Exponent, _Ratio, _Type>::unit_t;

  using unit_t<'Q', _Exponent, _Ratio, _Type>::operator*;
};

inline namespace literals
{
template <char... _Digits>
constexpr auto operator""_mC()
{
