...
using area_t = unit_t<'L', 2, _Type, _Ratio>;

template <typename _Type, typename _Ratio = std::ratio<1>>
using volume_t = unit_t<'L', 3, _Type, _Ratio>;

inline namespace literals
{
template <char... _Digits>
constexpr auto operator""_m2()
{
